...
vars = [x y z phi theta psi u v w p q r m Ixx Iyy Izz g l u1 u2 u3 u4]';
...
%% Sanity check - linear/nonlinear test
xdot_1 = A*state + B*(controls - ubar + [1;1;1;1]);
xdot_2 = nonlinear_dynamics(state, controls + [1;1;1;1]);
% Two are equivalent - we are sane